        ...
        Padding(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              hintText: 'Rechercher une maladie, un germe ou un antibiotique…',
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: [
              ...
              _filterChip('bacterial', 'Bactériennes'),
              const SizedBox(width: 8),
              _filterChip('parasitic', 'Parasitaires'),
              const SizedBox(width: 8),
              _filterChip('viral', 'Virales'),
            ],
          ),
        ),
